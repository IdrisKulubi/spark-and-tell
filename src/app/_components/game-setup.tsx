				...
				<div className="space-y-6">
					<div>
						...
						<input
							...
							className="w-full rounded-xl bg-white/20 px-4 py-3 text-white placeholder-white/50 backdrop-blur-sm focus:bg-white/30 focus:outline-none"
						/>
					</div>
					...
					<motion.button
						...
						className="w-full rounded-full bg-white py-4 font-bold text-purple-600 text-xl shadow-xl transition-shadow hover:shadow-white/30"
					>
						Let's Play! 🎲
					</motion.button>
				</div>
...
function DateTypeButton({
	...
	return (
		<motion.button
			...
			whileTap={{ scale: 0.98 }}
			onClick={onClick}
			className={`flex w-full items-center rounded-xl p-3 text-left transition-colors ${
