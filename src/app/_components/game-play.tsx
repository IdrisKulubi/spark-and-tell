...
export function GamePlay() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-pink-500 via-purple-600 to-indigo-700 p-4">
					...
					{gamePhase === "playing" && currentQuestion && (
						<>
							...
							<motion.button
								...
								className="rounded-full bg-white px-8 py-3 font-bold text-lg text-purple-600 shadow-xl hover:shadow-white/30"
							>
								I've Answered! ✅
							</motion.button>
						</>
