	...
	return (
		<div className="mx-auto w-full max-w-2xl">
			...
			>
				...
				<p className="text-white/80">How did their answer make you feel?</p>
			</motion.div>
			...
			<div className="mb-6 grid grid-cols-2 gap-3 md:grid-cols-4">
				{SPARK_REACTIONS.map((reaction, index) => (
					...
					>
						<div className="mb-1 text-3xl">{reaction.emoji}</div>
						<div
			...
			{selectedSparks.length > 0 && (
				...
				>
					<div className="text-lg text-white">
						Total: <span className="font-bold text-2xl">+{totalPoints}</span>{" "}
						sparks
					</div>
				</motion.div>
			)}
			...
			<motion.button
				...
				className="w-full rounded-full bg-white py-4 font-bold text-xl text-purple-600 shadow-xl transition-all hover:shadow-white/30"
			>
				{selectedSparks.length > 0
