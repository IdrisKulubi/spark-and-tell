...
export function SparkDisplay({
	...
	return (
		<div className="mx-auto w-full max-w-4xl">
			...
			<div className="grid grid-cols-2 gap-4">
				...
				>
					{currentTurn === 1 && (
						...
						>
							<span className="rounded-full bg-white px-3 py-1 font-bold text-purple-600 text-xs">
								YOUR TURN
							</span>
						</motion.div>
					)}
					<div className="text-center">
						...
						<div className="text-sm text-white/70">sparks</div>
					</div>
				</motion.div>
			...
			>
				<span className="text-sm">Total Connection Score: </span>
